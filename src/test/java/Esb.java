...
public class Esb {
	static Logger LOG = LoggerFactory.getLogger(Esb.class);
	public static void main(String[] args) throws Exception {
		configureLogging("src/test/config/logback.xml");
		new Esb().run();
	}
	void run() throws Exception {
		ApplicationContext spring = new FileSystemXmlApplicationContext(new String[]{"src/test/esb/context.xml"});
		...
		final RouteLoader loader=new RouteLoader(context, new File("src/test/esb/packages"), 1);
